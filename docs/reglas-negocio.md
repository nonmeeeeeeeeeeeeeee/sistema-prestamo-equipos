...
| RN-06 | Una solicitud debe incluir entre 1 y 3 equipos. | Al crear una solicitud. | Solicitudes sin equipos o con más de 3 equipos se rechazan. | AMB-05 / RF-05 | `src/prestamos/servicios/solicitudes.py` | CP-09, CP-10 |
